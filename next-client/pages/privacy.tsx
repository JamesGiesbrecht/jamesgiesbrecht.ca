...
import { Container, Typography, Link, Box, Theme } from '@mui/material'
...
const Privacy: FC = () => {
  ...
  return (
    <Container>
      ...
      <Typography variant="subtitle2">Last updated: February 27, 2021</Typography>
      <br />
      <Typography>
          ...
          <ul>
            ...
            <li>
              <Typography>
                ...
                in this Agreement) refers to James Giesbrecht.
              </Typography>
            </li>
            <li>
              <Typography>
            ...
            <li>
              <Typography>
                <strong>Country</strong> refers to: Manitoba, Canada
              </Typography>
            </li>
            <li>
              <Typography>
            ...
            <li>
              <Typography>
                <strong>Website</strong> refers to James Giesbrecht, accessible from{' '}
                <Link href="https://jamesgiesbrecht.ca" rel="noreferrer" target="_blank">
                  https://jamesgiesbrecht.ca
                </Link>
              </Typography>
            </li>
            <li>
      ...
      <Box className={classes.section}>
        <Typography variant="h4">Collecting and Using Your Personal Data</Typography>
        <Box className={classes.subSection}>
        ...
        <Box className={classes.subSection}>
          ...
          <Typography>
            ...
            in place including the msecurity of Your data and other personal information.
          </Typography>
        </Box>
        <Box className={classes.subSection}>
      ...
      <Box className={classes.section}>
        ...
        <ul>
          <li>By email: giesbrechtjames@gmail.com</li>
        </ul>
      </Box>
    </Container>
  )
